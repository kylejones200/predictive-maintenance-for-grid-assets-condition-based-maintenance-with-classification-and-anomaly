...
def prepare_anomaly_train(
    dist_test, dist_train, root, threshold, x_test_pca, x_train_pca
) -> None:
...
def prepare_x_pred_test(model, scored_train, x_test) -> None:
...
def main() -> None:
    ...
    prepare_act_func(x_train)
    prepare_x_pred_test(model, scored_train, x_test)
